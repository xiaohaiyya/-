    ...
    <div class="container">
        ...
        <div>
            <el-form :inline="true" :model="formInline" class="demo-form-inline rowcenter">
                ...
                <el-form-item label="使用状态：">
                    <el-select v-model="formInline.region" placeholder="使用状态">
                        <el-option label="未完成" value="shanghai"></el-option>
                        <el-option label="已完成" value="beijing"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="车辆状态：">
                    <el-select v-model="formInline.region" placeholder="车辆状态">
        ...
        <div>
            <el-table :data="tableData" border style="width: 100%">
                <el-table-column prop="date" label="车辆ID" align="center"></el-table-column>
                <el-table-column prop="date" label="二维码" align="center"></el-table-column>
                <el-table-column prop="date" label="设备编码" align="center"></el-table-column>
                <el-table-column prop="date" label="在线状态" align="center"></el-table-column>
                <el-table-column prop="date" label="电量%" align="center"></el-table-column>
                <el-table-column prop="date" label="车辆状态" align="center"></el-table-column>
